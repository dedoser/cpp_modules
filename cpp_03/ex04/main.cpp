...
/*   Updated: 2021/04/22 19:59:59 by fignigno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	SuperTrap sp("Amalgadon");
	SuperTrap sp1(sp);
	SuperTrap sp2("");
	sp2 = sp;
	sp.rangedAttack("SUPERTRAP");
	sp.meleeAttack("Murlock");
	std ::cout << sp.getHP() << std::endl << sp.getMaxHP() << std::endl << sp.getEnergy() << std::endl << sp.getMaxEnergy() << std::endl <<
		sp.getMeleeDmg() << std::endl << sp.getRangedDmg() << std::endl << sp.getArmor() << std::endl;
}
